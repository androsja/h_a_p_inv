...
def update_state(
    ...
    **kwargs
    ...
    # (Opcional: añadir bases para fees/slippage si runner las tuviera)
    ...
    new_s = BotState(
        ...
        total_sim_gross_profit=ts_gross_profit, # Added this line
        total_sim_gross_loss=ts_gross_loss,     # Added this line
